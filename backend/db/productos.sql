...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-05-2021 a las 12:47:21
...
INSERT INTO `cart` (`user`, `codigo_producto`, `qty`) VALUES
('jubelltols', 'B22716-1', 2);
...
('http://localhost/website/view/img/car_1.jpg', 'Calzado'),
('http://localhost/website/view/img/car_2.jpg', 'Accesorio'),
('http://localhost/website/view/img/car_3.jpg', 'Ropa');
...
('B22716-1', 'adidas', 'ADIDAS CAMPUS ADV', 54, 46, 'NEGRO', 'zapatillas Adidas Campus adv negro', 'view/img/zapatillas-adidas-campus-adv-negro-.png', 'Calzado', 'Hombre', '83'),
('EE6147', 'adidas', 'ADIDAS CAMPUS ADV NEGRO', 55, 39, 'negro', 'zapatillas Adidas Campus adv negro', 'view/img/zapatillas-adidas-campus-adv-negro.png', 'Calzado', 'Niño', '84'),
...
('EQYZT05482', 'quiksilver', 'QUIKSILVER INSIDE LINES SS BEI', 19, 0, 'Beige', 'camisetas de manga corta Quiksilver Inside lines ss beige', 'view/img/camisetas-de-manga-corta-quiksilver-inside-lines-ss-beige.jpg', 'Ropa', 'Hombre', '17'),
...
('', 'jubelltols', 'jubelltols@gmail.com', '$2y$10$OpR34X71Gsk5T7hisZ', 'client', 'https://robohash.org/2cd5d4fe8b458a33af1d478c761d0022', '', 1),
COMMIT;

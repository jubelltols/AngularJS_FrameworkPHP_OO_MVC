<?php
	class shop_bll {
		...
		public function get_list_products_BLL() {
			return $this -> dao -> select_list_products($this->db);
		}

		public function get_list_filters_products_BLL($args) {
			return $this -> dao -> select_list_filters_products($this->db, $args);
		}
		...
		public function get_insert_cart_BLL($args) {
			$jwt = jwt_process::decode(json_decode($args[0]));
			$jwt = json_decode($jwt, TRUE);
